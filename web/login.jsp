		...
		<form action="/login"   method="post" id="loginForm">
			<table border="0">
				...
				<tr>
					...
					<td class="input">
						<input pattern="^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{8,}$" required title="至少8个字符且同时包含字母和数字" required="required" type="password" name="password"  id="password" class="login_input"/>
					</td>
				...
				<tr>
					<td colspan="2">
						<input required="required" class="btn" type="submit" value="登录"/>



					</td>
					<td>
						<a href="register.jsp">点我注册吧</a>
					</td>
				</tr>
			</table>
		</form>
